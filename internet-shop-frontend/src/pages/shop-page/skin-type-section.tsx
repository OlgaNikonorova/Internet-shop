    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        {[
          {
            title: "СУХАЯ КОЖА",
            description: "Твоя кожа часто шелушится, склонна к покраснениям и ты часто ощущаешь чувство стянутости? Ты обладатель сухой кожи!",
          ...
          {
            title: "ЖИРНАЯ КОЖА",
            description: "Твоя кожа быстро начинает блестеть, часто появляются прыщи и расширенные поры? У тебя жирная кожа!",
            ...
            avoid: "Минеральных и кокосовых масел, ланолина, плотных текстур и комедогенных компонентов"
          },
          {
            title: "КОМБИНИРОВАННАЯ КОЖА",
            description: "Лоб, нос и подбородок блестят, а щёки — нормальные или сухие? У тебя комбинированная кожа!",
            ...
            avoid: "Жирных универсальных кремов, спиртосодержащих лосьонов, абразивных скрабов"
          },
          {
            title: "НОРМАЛЬНАЯ КОЖА",
            description: "Кожа ровная, без покраснений и жирного блеска? Не шелушится и не вызывает дискомфорта? Поздравляем, у тебя нормальная кожа!",
            care: "Лёгкие пенки или гели, кремы с пантенолом, ниацинамидом, алоэ вера, витамином Е, базовое увлажнение, регулярный SPF 30+",
            avoid: "Жёстких очищающих средств, частого использования кислот и сильных активов без показаний"
          }
        ].map((item, index) => (
          <Accordion 
            key={index}
